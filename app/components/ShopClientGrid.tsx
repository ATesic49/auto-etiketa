    ...
    return (
        <>
            <div className='flex flex-col justify-center items-center gap-4'>
                <h1 className='md:text-5xl md:text-left text-center text-2xl font-black '>World&apos;s Best Car Tag Supplier </h1>
                <div className='flex flex-center items-center gap-1 justify-center flex-col'>
                    <p className='text-gray-400 md:text-lg font-medium'>See for yourself </p>
