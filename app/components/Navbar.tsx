...
function Navbar() {
    ...
    return (
        <div className='flex px-8 py-4  border-b-2 gap-8 md:gap-16 justify-start items-center sticky top-0 z-[9] bg-white border-gray-400'>
            ...
            <nav className='flex   justify-center text-gray-500 font-semibold text-sm md:text-base gap-4 items-center underline-offset-8 duration-200'>
            ...
            <div className='ml-auto flex items-center justify-center gap-2 md:gap-4'>
                ...
                <Link href={'/shop#search'} >
                    <svg xmlns="http://www.w3.org/2000/svg" className="md:w-8 w-6 aspect-square stroke-gray-800" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#000000" fill="none" strokeLinecap="round" strokeLinejoin="round">
