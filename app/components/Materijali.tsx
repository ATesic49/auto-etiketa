...
function Materijali() {
	return (
		<div className="flex flex-col w-full px-8 md:px-16 items-center justify-center md:gap-0 gap-8 mt-16">
			...
			<div className="flex w-full justify-between items-center md:flex-row-reverse flex-col-reverse  gap-8">
				<div className="flex flex-col gap-4 md:gap-2 font-medium text-sm md:text-lg justify-center text-gray-400">
