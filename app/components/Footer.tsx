...
function Footer() {
    return (
        <div className='flex px-8 py-4 border-t items-center justify-between relative'>
            <div className='flex md:text-base text-sm items-center justify-center gap-2 text-gray-500 font-medium'>
                <Link href={'/'}>
                    <Image alt='AutoEtiketa' className='aspect-square w-16 -my-4 mr-8' src={Logo}></Image>
                </Link>

                <Link href={'/'} className='md:text-base text-sm '  >Home</Link>
                <Link href={'/shop'} className='md:text-base text-sm '>Shop</Link>

            </div>



            <div className='text-xs mt-auto text-gray-500 absolute  bottom-2 md:bottom-4 left-[calc(50%_+_16px)] md:left-1/2 -translate-x-1/2'>
