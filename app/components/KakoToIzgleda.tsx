...
function KakoToIzgleda() {
    ...
    return (
        <div className='flex w-full items-center justify-center flex-col gap-8 md:gap-16 mt-8 md:mt-16 '>
            <h2 className='font-black text-2xl md:text-4xl text-gray-800'>Kako to izgleda</h2>
            <div className='grid grid-cols-4 w-full gap-4 px-4 md:px-8'
                ref={ref}>
                <motion.div className='row-span-2  relative w-full  aspect-[1/3] md:aspect-[1/1.6]'
                    initial={{ opacity: 0 }}
                ...
                <motion.div className='relative col-span-2'
                    ...
                    transition={{ delay: .75 }}
                >
                    <Image className='object-cover md:object-[0_-3rem]' fill src={sika4} alt=''></Image>
                </motion.div>
            ...
            <Link href={'/shop'} tabIndex={1} className='px-4 py-2 border-2 text-gray-500 font-medium bo-rder-gray-500 md:-mt-8 rounded-lg'>Poruči odmah.</Link>
        </div>
    )
}
